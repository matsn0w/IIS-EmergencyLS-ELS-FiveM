...
RegisterKeyMapping('MISS-ELS:open-vehicle-control-menu', 'Open vehicle control menu', 'KEYBOARD', 'U')
RegisterKeyMapping('MISS-ELS:toggle-flashing-highbeams', 'Toggle flashing highbeams', 'KEYBOARD', 'J')
