...
export const state = () => ({
  ...
  configuration: {
    ...
    patterns: [
      { name: 'PRIMARY', isEmergency: true, flashHighBeam: false, enableWarningBeep: false },
      { name: 'SECONDARY', isEmergency: true, flashHighBeam: false, enableWarningBeep: false },
      { name: 'REARREDS', isEmergency: true, flashHighBeam: false, enableWarningBeep: false }
    ],
    flashes: []
  }
})
